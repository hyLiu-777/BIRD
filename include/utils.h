...
const std::string MCSP = "mcsp";
const std::string PISP = "pisp";
const std::string ABHPP = "abhpp";
const std::string BDPush = "BDPush";
const std::string RBHPP = "BDPush";
...
struct Config{
    ...
    void check(){
        std::vector<std::string> Algos = {PI,PISP,MCSP,ABHPP,RBHPP,BDPush};
    ...
    void setIteration(double eps){
        iteration = log(2.0/eps)/log(1.0/(1.0-alpha))-1;
    }

    void setNumWalks(double eps, uint n){
        double pfail= 1.0/n;
        numwalks = 2*(1.0+eps/3.0)*log(n/pfail)/eps/eps;
    }
};
